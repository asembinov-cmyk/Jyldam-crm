...
function bindSortRowClicks(){
  // Двойное касание считает общий помощник bindDoubleTap (js/01-yadro.js): штатный dblclick
  // Safari на айфоне для строк таблицы отдаёт ненадёжно, на этом уже обожглись.
  document.querySelectorAll('[data-sortrow]').forEach(tr=>bindDoubleTap(tr,()=>{
